...
If you finish the core exercise early and want to explore more type composition concepts, check out **[EXTENSIONS.md](./EXTENSIONS.md)** for optional exercises covering:

- **Utility Types** (`Pick`, `Partial`, `Omit`, etc.) - 5-10 minutes
- **Conditional Types** - 5-10 minutes (Advanced)
- **Mapped Types & `keyof`** - 5-10 minutes (Advanced)

These extensions build on what you've learned and introduce additional type composition techniques from Section 10.
